    ...
    <h1 className="text-6xl py-6 text-center">EQUIPE</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 py-6 justify-items-center rounded-xl">
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Médica Geriátra, especialista em cuidado do idoso e prevenção de doenças cardiovasculares. Formada pela Universidade Federal de Minas Gerais.</p>
        </div>
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Psicóloga especialista em saúde da mente na terceira idade e qualidade de vida após os 70. Formada pela Universidade Federal do Espírito Santo.</p>
        </div>
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Ortopedista e Fisioterapeuta, especialista em recuperação de traumas oriundos de artrite e artrose na terceira idade. Formado pela PUC-MG</p>
        </div>
        ...
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Terapeuta Ocupacional especialista em Terapia Ocupacional na terceira idade. Conhecida pela entrevista dada à Revista Veja de agosto-2022. Formada pela Universidade de São Paulo (USP), Campus Ribeirão Preto.</p>
        </div>
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Renomado Cirurgião Plástico especializado em cirurgias na terceira idade. Formado pela Universidade de Federal de São Carlos.</p>
        </div>
        <div className="p-8 col-span-1 grid justify-items-center">
          ...
          <p className="md:text-xl text-base">Médica Neurologista especialista em saúde mental e demência na terceira idade. Formada pela Universidade Federal do Mato Grosso do Sul. </p>
        </div> 
      </div>
