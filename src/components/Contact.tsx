  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 place-items-center my-8 mx-6">
            ...
            <div className="bg-green-100 md:bg-white hover:bg-green-100 duration-700 col-span-1 rounded-xl my-8 px-4 py-4 md:p-24 text-center">
                <p className=" text-2xl py-1">Rua Padre Anchieta</p>
                <p className=" text-2xl py-1">CEP 11253-632</p>
                <p className=" text-2xl py-1">(11) 9797-9797</p>
                <p className=" text-2xl py-1">cep 11253-632</p>
            </div>
        </div>
    </div>
